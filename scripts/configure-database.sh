...
sed -i "s/template_service/${DATABASE}/g" database/template/1_create_initial_schema.up.sql
...
sed -i "s/template_service/${DATABASE}/h" internal/controller/helper_test.go

echo "Consolidating config files..."
sed -i "s/template_service/${DATABASE}/h" cmd/app/configs/config-prod.yml
sed -i "s/template_service/${DATABASE}/h" cmd/app/configs/config-template-dev.yml

sed -i "s/template_service/${DATABASE}/h" cmd/app/internal/config.go
sed -i "s/template_service/${DATABASE}/h" cmd/app/internal/config_test.go
